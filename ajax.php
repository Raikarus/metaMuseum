        ...
        if($_POST['mod'] == "gallery")
        {
            ...
            if(pg_fetch_result($res, $start, 0))
            {
    	        for ($i=$start; $i < $end; $i++) { 
                 ...
                 if($pic_id)
                 {
                    if(in_array($pic_id, $pre_podborka)) echo "<li class='photo_li' style='outline:3px solid red;outline-offset:-3px' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";   
                    else if(in_array($pic_id, $podborka)) echo "<li class='photo_li' style='outline:3px solid green;outline-offset:-3px' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";
                    else echo "<li class='photo_li' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";
                 }
    	        }
        	}
        	else
                ...
                if($_POST['podborka'])
                {
                    ...
                    if(pg_fetch_result($res, $start, 0)){
                        for ($i=$start; $i < $end; $i++) { 
                         ...
                         $title = pg_fetch_result($res, $i, 2);
                         if($pic_id){
                            if(in_array($pic_id, $selected_in_podborka)) echo "<li class='photo_li' style='outline:3px solid red;outline-offset:-3px' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";
                            else echo "<li class='photo_li' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";
                         } 
                        }
                    }
            ...
            if(pg_fetch_result($res, $start, 0)){
                for ($i=$start; $i < $end; $i++) { 
                 ...
                 if($pic_id){
                    ...
                    // else
                    echo "<li class='photo_li' data-id=$pic_id><div class='photo' style='background-image:url(".'"img/'.$pic_id.".".$fmt.'"'.")'></div><div class='name'><div class = 'name_div'>$title</div></div></li>";
                 } 
                }
            }
            else
